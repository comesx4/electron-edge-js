...
public class JavascriptObjectRepository
{
    ...
    List<JavascriptObject> GetObjects(List<string> names)
    {
    ...
    public JavascriptObject Register(object value)
    {
        if (value == null)
        {
    ...
    public TryCallMethodResult TryCallMethod(long objectId, string name, object[] parameters)
    {
        var exception = "";
        object result = null;
        JavascriptObject obj;
    ...
    public async Task<TryCallMethodResult> TryCallMethodAsync(long objectId, string name, object[] parameters)
    {
        var exception = "";
        object result = null;
        JavascriptObject obj;
